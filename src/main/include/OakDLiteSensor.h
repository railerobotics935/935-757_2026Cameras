...
//  OakDLiteSensor (std::string cameraName, frc::Pose3d cameraPose3d, frc::SwerveDrivePoseEstimator<4>* poseEstimator);
  OakDLiteSensor (std::string cameraName, frc::Pose3d cameraPose3d);
  ...
  */
  ...
  /**
   * @return True if the object is a Fuel
  */
  bool ObjectIsFuel(int object);
